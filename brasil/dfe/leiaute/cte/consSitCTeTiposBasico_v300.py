...
TVerConsSitCTe: TypeAlias = Annotated[str, SimpleType, """ Tipo Versão do Consulta situação de CT-e - 2.00""", ]
...
class TRetConsSitCTe(ComplexType):
    ...
    class _protCTe(ComplexType):
        ...
        versao: Annotated[str, Attribute(enumeration=['1.03', '1.04', '2.00', '3.00'])] = None
