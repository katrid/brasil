...
class TCTe(ComplexType):
    ...
    class _infCte(ComplexType):
        ...
        class _ide(ComplexType):
            ...
            forPag: Annotated[str, Element] = None
            ...
            class _toma03(ComplexType):
                """Indicador do \"papel\" do tomador do serviço no CT-e"""
                toma: Annotated[str, Element] = None

            toma03: Annotated[_toma03, Element] = None
            ...
            toma03_toma4 = Choice("toma03", "toma4")
            dhCont: Annotated[str, Element] = None
...
Grupo a ser informado nas prestações interestaduais para consumidor final, não contribuinte do ICMS"""
                ...
                pICMSInterPart: Annotated[TDec_0302, Element] = None
...
Este grupo deve ser informado quando o documento originário for NF """
                    ...
                    infUnidCarga: Annotated[ElementList[TUnidCarga], Element] = None
                    infUnidTransp_infUnidCarga = Choice("infUnidTransp", "infUnidCarga")
            ...
            class _seg(ComplexType):
                ...
                vCarga: Annotated[TDec_1302Opc, Element] = None
...
Não deve ser preenchido para modal dutoviário.
                ...
                pontoFulgor: Annotated[str, Element] = None
            ...
            class _infCteSub(ComplexType):
                ...
                class _tomaNaoICMS(ComplexType):
                    """Tomador não é contribuinte do ICMS"""
                    refCteAnu: Annotated[TChNFe, Element] = None

                tomaNaoICMS: Annotated[_tomaNaoICMS, Element] = None
                tomaICMS_tomaNaoICMS = Choice("tomaICMS", "tomaNaoICMS")
