...
TVerCTe: TypeAlias = Annotated[str, SimpleType, """Tipo Versão do CT-e - 3.00""", ]
...
TFinCTeOS: TypeAlias = Annotated[str, SimpleType, """Tipo Finalidade da CT-e Outros Serviços""", ]
