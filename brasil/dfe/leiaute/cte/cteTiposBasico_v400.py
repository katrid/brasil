...
class TGTVe(ComplexType):
    ...
    class _infCte(ComplexType):
        ...
        class _ide(ComplexType):
            ...
            tpCTe: Annotated[TFinGTVe, Element] = None
            ...
            class _tomaTerceiro(ComplexType):
...
Poderá não ser informado para os CT-e de redespacho intermediário e serviço vinculado a multimodal. Nos demais casos deverá sempre ser informado."""
        ...
        origem: Annotated[TEndeEmi, Element] = None
        destino: Annotated[TEndeEmi, Element] = None

        class _detGTV(ComplexType):
            ...
            class _infEspecie(ComplexType):
                ...
                tpNumerario: Annotated[str, Element] = None
                xMoedaEstr: Annotated[str, Element] = None

            infEspecie: Annotated[ElementList[_infEspecie], Element] = None
            qCarga: Annotated[TDec_1104, Element] = None

            class _infVeiculo(ComplexType):
            ...
            infVeiculo: Annotated[ElementList[_infVeiculo], Element] = None

        detGTV: Annotated[_detGTV, Element] = None
...
Este grupo deve ser informado quando o documento originário for NF """
            ...
            class _infServVinc(ComplexType):
                ...
                class _infCTeMultimodal(ComplexType):
                    ...
                    chCTeMultimodal: Annotated[TChDFe, Element] = None
        ...
        infCteComp: Annotated[ElementList[_infCteComp], Element] = None
        infCTeNorm_infCteComp = Choice("infCTeNorm", "infCteComp")
...
Obrigatório para Pessoas e Bagagem"""
            ...
            infCteSub: Annotated[_infCteSub, Element] = None
            refCTeCanc: Annotated[TChDFe, Element] = None
            ...
            infGTVe: Annotated[ElementList[_infGTVe], Element] = None
