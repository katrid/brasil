...
class retDistDFeInt(ComplexType):
    ...
    verAplic: TVerAplic = Element(TVerAplic, documentation=['Versão do Web Service CTeDistribuicaoDFe'])
    ...
    dhResp: str = Element(str, documentation=['Data e Hora de processamento da requisição no formato AAAA-MM-DDTHH:MM:SS'])
