...
class TCOrgaoIBGE(str):
    ...
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", enumeration=['11', '12', '13', '14', '15', '16', '17', '21', '22', '23', '24', '25', '26', '27', '28', '29', '31', '32', '33', '35', '41', '42', '43', '50', '51', '52', '53', '90', '91', '93', '94', '95', '96'])
    pass
...
class TIeDest(str):
    ...
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", pattern=r"[0-9]{0,14}|ISENTO", max_length=r"14", enumeration=[])
    pass
...
class TModCTOS(str):
    ...
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", enumeration=['67'])
    pass
...
class TModGTVe(str):
    """Tipo Modelo Documento Fiscal"""
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", enumeration=['64'])
    pass
...
class TModCT_Carga_OS(str):
    """Tipo Modelo Documento Fiscal"""
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", enumeration=['57', '67'])
    pass
