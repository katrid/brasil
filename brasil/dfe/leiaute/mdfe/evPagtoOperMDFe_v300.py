...
class evPagtoOperMDFe(ComplexType):
    ...
    descEvento: str = Element(str, documentation=['Descrição do Evento - “Pagamento Operação MDF-e”'])
    ...
    class infViagens(ComplexType):
        """Informações do total de viagens acobertadas pelo Evento “pagamento do frete”"""
        qtdViagens: str = Element(str, documentation=['Quantidade total de viagens realizadas com o pagamento do Frete'])
        nroViagem: str = Element(str, documentation=['Número de referência da viagem do MDFe referenciado.'])
    infViagens: infViagens = Element(infViagens, documentation=['Informações do total de viagens acobertadas pelo Evento “pagamento do frete”'])
    ...
    class infPag(ComplexType):
        ...
        def add(self, xNome=None, CPF=None, CNPJ=None, idEstrangeiro=None, Comp=None, vContrato=None, indPag=None, vAdiant=None, indAntecipaAdiant=None, infPrazo=None, tpAntecip=None, infBanc=None) -> evPagtoOperMDFe.infPag:
        ...
        class Comp(ComplexType):
            ...
            def add(self, tpComp=None, vComp=None, xComp=None) -> evPagtoOperMDFe.infPag.Comp:
...
Informar somente se indPag for à Prazo"""
            ...
            def add(self, nParcela=None, dVenc=None, vParcela=None) -> evPagtoOperMDFe.infPag.infPrazo:
...
evPagtoOperMDFe: evPagtoOperMDFe = Element(evPagtoOperMDFe, documentation=['Schema XML de validação do evento de pagamento da operação de transporte 110116'])
