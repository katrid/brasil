...
class detEvento(ComplexType):
    ...
    dhHashComprovante: TDateTimeUTC = Element(TDateTimeUTC, documentation=['Data e hora da geração do hash do Comprovante de Entrega da NF-e. Formato AAAA-MMDDThh:mm:ssTZD.\n\t\t\t\t'])
