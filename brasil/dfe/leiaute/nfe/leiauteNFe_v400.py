...
(NT 2011/004)"""
                ...
                class comb(ComplexType):
                    ...
                    pGLP: TDec_0302a04Max100 = Element(TDec_0302a04Max100)
                    pGNn: TDec_0302a04Max100 = Element(TDec_0302a04Max100)
                    pGNi: TDec_0302a04Max100 = Element(TDec_0302a04Max100)
                    vPart: TDec_1302 = Element(TDec_1302)
...
00 - Tributada integralmente"""
                        ...
                        pFCP: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCP: TDec_1302 = Element(TDec_1302)
...
10 - Tributada e com cobrança do ICMS por substituição tributária"""
                        ...
                        pICMS: TDec_0302a04 = Element(TDec_0302a04)
                        vICMS: TDec_1302 = Element(TDec_1302)
                        vBCFCP: TDec_1302 = Element(TDec_1302)
                        pFCP: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCP: TDec_1302 = Element(TDec_1302)
                        ...
                        vBCFCPST: TDec_1302 = Element(TDec_1302)
                        pFCPST: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCPST: TDec_1302 = Element(TDec_1302)
                        vICMSSTDeson: TDec_1302 = Element(TDec_1302)
...
A exigência do preenchimento das informações do ICMS diferido fica à critério de cada UF."""
                        ...
                        pFCP: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCP: TDec_1302 = Element(TDec_1302)
                        pFCPDif: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCPDif: TDec_1302 = Element(TDec_1302)
                        vFCPEfet: TDec_1302 = Element(TDec_1302)
...
60 - ICMS cobrado anteriormente por substituição tributária"""
                        ...
                        pST: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vICMSSubstituto: TDec_1302 = Element(TDec_1302)
                        vICMSSTRet: TDec_1302 = Element(TDec_1302)
                        vBCFCPSTRet: TDec_1302 = Element(TDec_1302)
                        pFCPSTRet: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vFCPSTRet: TDec_1302 = Element(TDec_1302)
                        pRedBCEfet: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vBCEfet: TDec_1302 = Element(TDec_1302)
                        pICMSEfet: TDec_0302a04Opc = Element(TDec_0302a04Opc)
                        vICMSEfet: TDec_1302 = Element(TDec_1302)
...
Substituição Tributaria;"""
                ...
                class ICMSUFDest(ComplexType):
                    ...
                    vBCFCPUFDest: TDec_1302 = Element(TDec_1302)
        ...
        class cobr(ComplexType):
            ...
            class fat(ComplexType):
                ...
                vOrig: TDec_1302 = Element(TDec_1302)
                vDesc: TDec_1302 = Element(TDec_1302)
                vLiq: TDec_1302 = Element(TDec_1302)
            fat: fat = Element(fat)
        ...
        class pag(ComplexType):
            ...
            vTroco: TDec_1302 = Element(TDec_1302)
        pag: pag = Element(pag)
