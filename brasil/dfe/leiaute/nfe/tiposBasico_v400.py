...
class TDec_0104v(str):
    """Tipo Decimal com até 1 dígitos inteiros, podendo ter de 1 até 4 decimais"""
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", pattern=r"0|0\.[0-9]{1,4}|[1-9]{1}(\.[0-9]{1,4})?", enumeration=[])
    pass
...
class TDec_0304Max100(str):
    """Tipo Decimal com 3 inteiros (no máximo 100), com 4 decimais"""
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", pattern=r"0(\.[0-9]{4})?|100(\.00)?|[1-9]{1}[0-9]{0,1}(\.[0-9]{4})?", enumeration=[])
    pass
...
class TDec_0302a04Max100(str):
    ...
    _restriction = Restriction(base=r"xs:string", white_space=r"preserve", pattern=r"0(\.[0-9]{2,4})?|[1-9]{1}[0-9]{0,1}(\.[0-9]{2,4})?|100(\.0{2,4})?", enumeration=[])
    pass
