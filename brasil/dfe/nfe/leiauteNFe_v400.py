...
para tpEmis diferente de 1"""
            ...
            indIntermed: str = Element(str, min_occurs=0)
        ...
        class det(ComplexType):
            class prod(ComplexType):
                ...
                cBarra: str = Element(str, min_occurs=0)
                xProd: str = Element(str)
                NCM: str = Element(str)
                NVE: List[str] = Element(str, min_occurs=0, max_occurs=8)
                CEST: str = Element(str)
                indEscala: str = Element(str, min_occurs=0)
                CNPJFab: TCnpj = Element(TCnpj, min_occurs=0)
                cBenef: str = Element(str, min_occurs=0)
                ...
                cBarraTrib: str = Element(str, min_occurs=0)
                ...
                class DI(ComplexType):
                    ...
                    class adi(ComplexType):
                        nAdicao: str = Element(str, min_occurs=0)
                ...
                class rastro(ComplexType):
                    ...
                    cAgreg: str = Element(str, min_occurs=0)
                rastro: rastro
            prod: prod
            class imposto(ComplexType):
                ...
                class PISST(ComplexType):
                    ...
                    indSomaPISST: str = Element(str, min_occurs=0)
                PISST: PISST
                ...
                class COFINSST(ComplexType):
                    ...
                    indSomaCOFINSST: str = Element(str, min_occurs=0)
                COFINSST: COFINSST
                class ICMSUFDest(ComplexType):
                    vBCUFDest: TDec_1302 = Element(TDec_1302)
                    vBCFCPUFDest: TDec_1302 = Element(TDec_1302, min_occurs=0)
                    pFCPUFDest: TDec_0302a04 = Element(TDec_0302a04, min_occurs=0)
        ...
        class cobr(ComplexType):
            class fat(ComplexType):
                ...
                vOrig: TDec_1302 = Element(TDec_1302, min_occurs=0)
                vDesc: TDec_1302 = Element(TDec_1302, min_occurs=0)
                vLiq: TDec_1302 = Element(TDec_1302, min_occurs=0)
            fat: fat
        ...
        class pag(ComplexType):
            class detPag(ComplexType):
                indPag: str = Element(str, min_occurs=0)
                tPag: str = Element(str)
                xPag: str = Element(str, min_occurs=0)
                ...
                card: card
            detPag: detPag
            vTroco: TDec_1302 = Element(TDec_1302, min_occurs=0)
        pag: pag
        ...
        cana: cana
        infRespTec: TInfRespTec = Element(TInfRespTec, min_occurs=0)
...
class TVeiculo(Element):
    ...
    placa: str = Element(str, min_occurs=0)
    UF: TUf = Element(TUf)
